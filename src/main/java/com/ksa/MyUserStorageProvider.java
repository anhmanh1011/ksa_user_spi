...
//        return userDAO.getUserByUsername(username).map(user -> getUserRepresentation(user, realm)).orElse(null);
//    }
//
//    @Override
//    public UserModel getUserByEmail(String email, RealmModel realm) {
//        log.info("getUserByEmail(String email, RealmModel realm)");
//        return userDAO.getUserByEmail(email).map(user -> getUserRepresentation(user, realm)).orElse(null);
//    }
//}
